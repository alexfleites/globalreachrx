...
/******* Code For reading data from xml file format and writing it into html file format**********/
...
if(isset($_POST['import']))
{
	...
	if($ACS->fileUpload($_FILES['uploadXML'],"",$ACS->maxSize,array("xml")))
	{  
		//get the path of the uploaded file	
		$path=$ACS->uploadedFileName;
		
		/* Step 3: call the convert method to reading the xml Format and generate file in html format*/			
		$ACS->convert("xml","html",$path,$outputFile);
...
?>
<h4>HTML Generate From XML</h4><hr />
<div class="from">
...
/* $outputFileLocation = location of the output file (i.e. complete path of the output file)  */	
   $ACS->convert("xml","html",$xmlFileLocation,$outputFileLocation);
?&gt;    
</code>
</pre>
</div>