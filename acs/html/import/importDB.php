...
/******* Code For reading the html format and generate db format file in specific location******************/
...
if(isset($_POST['import']))
{
	...
	{  
		...
		/* Step 3: call the convert method to reading the html Format and generate file in db format*/			
