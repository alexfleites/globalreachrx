...
/******* Code For reading the xml format and generate pdf format file in specific location******************/
...
if(isset($_POST['import']))
{
	...
	// the file format is converting is file or not
	$ACS->isFile=true;
	...
	{  
		...
		/* Step 3: call the convert method to reading the xml Format and generate file in pdf format*/			
		$ACS->convert("xml","pdf",$path,$outputFile);
...
?>
<h4>PDF Generate From XML</h4><hr />
<div class="from">
