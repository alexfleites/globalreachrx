...
/******* Code For reading the db format and generate pdf format file in specific location******************/
...
// set whether first row is Tag or not (true or false)
	...
	$output=$_POST['outputPath'];
		...
		/* Step 3: call the convert method to reading the db Format and generate file in pdf format*/			
		$ACS->convert("db","pdf","",$output);
