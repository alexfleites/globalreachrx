...
/******* Code For reading the sql query and generate Excel format file in specific location******************/
...
if(isset($_POST['import']))
{
	...
	//set format of excel(.xls or .xlsx)
	...
	$ACS->convert("sql","excel",$sql,$outputFile);
...
<div class="from">
  ...
  <form method="post" enctype="multipart/form-data">
    ...
    <div class="formRow">
      ...
      <div class="formField">
        <input type="text" name="outputPath" value="file.xls" />
      </div>
    </div>
    <div class="formRow">
...
/* $outputFileLocation = location of the output file (i.e. complete path of the output file)  */	
   $ACS->convert("sql","excel",$sql,$outputFileLocation);
?&gt;    
</code>
</pre>
</div>