...
/******* select data from database using sql query and writing it into csv file format******************/
...
if(isset($_POST['import']))
{
	...
	/* Step 3: call the convert method to reading the sql query and create file in csv format*/			
	$ACS->convert("sql","csv",$sql,$outputFile);
  ...
  <form method="post" enctype="multipart/form-data">
    ...
    <div class="formRow">
      ...
      <div class="formField submit">
        <input type="submit" id="save" class="demosql" name="import" value="Save"/>
...
/* $outputFileLocation = location of the output file (i.e. complete path of the output file)  */	
   $ACS->convert("sql","csv",$sql,$outputFileLocation);
?&gt;    
</code>
</pre>
</div>
