...
/******* Code For reading the html format and insert data in database ********/
...
if(isset($_POST['import']))
{
	...
	if($ACS->fileUpload($_FILES['uploadCsv'],$ACS->fileUploadPath,$ACS->maxSize,array("html")))
	{  
		//get the path of the uploaded file	
		$path=$ACS->uploadedFileName;
		
		/* Step 3: call the convert method to reading the html Format and insert into database*/			
		$ACS->convert("html","db",$path);
...
?>
<h4>DB Generate From HTML</h4><hr />
<div class="from">
...
<div class="formRow">
<div class="formLabel">Upload HTML Table</div><div class="formField"><input type="file" id="File1" name="uploadCsv"  required="required"/></div>
</div>
<div class="formRow">
...
/* $outputFileLocation = location of the output file (i.e. complete path of the output file)  */	
   $ACS->convert("html","db",$htmlFileLocation,$outputFileLocation);
?&gt;    
</code>
</pre>
</div>