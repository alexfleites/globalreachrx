...
/******* Code For reading the excel format and generate xml format file in specific location******************/
...
if(isset($_POST['import']))
{
	...
	if($ACS->fileUpload($_FILES['uploadXsl'],$ACS->fileUploadPath,$ACS->maxSize,array("xls","xlsx")))
	{  
		//get the path of the uploaded file	
		$path=$ACS->uploadedFileName;
		
		/* Step 3: call the convert method to reading the excel Format and generate file in xml format*/			
		$ACS->convert("excel","xml",$path,$outputPath);
...
?>
<h4>XML Generate From Excel</h4><hr />
<div class="from">
...
<div class="formRow">
<div class="formLabel">Is First Row As Header</div><div class="formField"><input type="radio" name="firstRowHeader" value="true" checked="checked"/>&nbsp;&nbsp;True&nbsp;&nbsp;&nbsp;<input type="radio" name="firstRowHeader" value="false"/>&nbsp;&nbsp;False</div>
</div>
<div class="formRow">
