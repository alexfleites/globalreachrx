...
/******* Code For reading the xml format and insert into database*****************/
...
if(isset($_POST['import']))
{
	...
	{  
		...
		/* Step 3: call the convert method to reading the xml Format and insert data into database*/			
...
/* $xmlFileLocation    = location of the xml file (i.e. complete path of the uploaded xml file)  */
   ...
   $ACS->convert("xml","db",$xmlFileLocation);
?&gt;    
</code>
</pre>
</div>
