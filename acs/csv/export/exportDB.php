...
/******* Code For fetching the data from database and writing it into csv file format******************/
...
if(isset($_POST['import']))
{
    ...
    /*Step 3: call the convert method to fetching data rom database and convert it into csv Format*/			
    $ACS->convert("db","csv",'',$outputFile);
...
$keyword="convert csv to db,csv to Mysql, export Mysql, generate csv from Mysql, csv in php, format conversion, awesome conversion script,
 array to csv, php export csv, import csv";
require_once("../../header.php");
?>

<h4>CSV Generate From DB</h4>
<hr />
<div class="from">
...
/* $outputFileLocation = location of the output file (i.e. complete path of the output file)  */	
   $ACS->convert("db","csv",'',$outputFileLocation);
?&gt;    
</code>
</pre>
</div>
