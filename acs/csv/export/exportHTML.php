...
/******* Code For reading the html format and generate csv format file in specific location******************/
...
if(isset($_POST['import']))
{
	...
	{  
		...
		/* Step 3: call the convert method to reading the html Format and generate file in csv format*/			
		$ACS->convert("html","csv",$path,$outputFile);
...
?>
<h4>CSV Generate From HTML</h4><hr />
<div class="from">
...
/* $outputFileLocation = location of the output file (i.e. complete path of the output file)  */	
   $ACS->convert("html","csv",$htmlFileLocation,$outputFileLocation);
?&gt;    
</code>
</pre>
</div>