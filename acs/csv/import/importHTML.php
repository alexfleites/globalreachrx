...
/******* Code For reading the CSV format and generate html file in specific location or browser******************/
...
if(isset($_POST['import']))
{
	...
	// set whether first row is Table Head or not (true or false)		
	$ACS->useFirstRowAsTag=$_POST['firstRow'];
	...
	{  
		...
		/* Step 3: call the convert method to reading the csv Format and generate file in html format*/			
		$ACS->convert("csv","html",$path,$outputPath);
...
/* $outputFileLocation = location of the output file (i.e. complete path of the output file)  */	
   $ACS->convert("csv","html",$csvFileLocation,$outputFileLocation);
?&gt;    
</code>
</pre>
</div>