...
/** Code For reading the CSV format and generating file in pdf format at specific location ****/
...
if(isset($_POST['import']))
{
	...
	{  
		...
		/* Step 3: call the convert method to reading the csv Format and generate file in PDF format*/			
		$ACS->convert("csv","pdf",$path,$outputFile);
...
?>
<h4>Convert CSV to PDF</h4><hr />
<div class="from">
 <?php if(isset($message)) echo $message; ?>
<form method="post" enctype="multipart/form-data">
<div class="formRow">
<div class="formLabel">Upload CSV</div><div class="formField"><input type="file" id="File1" name="uploadCsv"  required="required"/></div>
</div>
<div class="formRow">
...
/* $csvFileLocation    = location of the csv file (i.e. complete path of the uploaded csv file)  */
/* $outputFileLocation = location of the output file (i.e. complete path of the output file)  */	
   $ACS->convert("csv","pdf",$csvFileLocation,$outputFileLocation);
?&gt;    
</code>
</pre>
</div>