...
/*******Code For reading the CSV format and writing it into xml file format ******************/
...
if(isset($_POST['import']))
{
	...
	{  
		...
		/* Step 3: call the convert method to reading the csv Format and generate file in xml format*/			
		$ACS->convert("csv","xml",$path,$outputFile);
...
/* $outputFileLocation = location of the output file (i.e. complete path of the output file)  */	
   $ACS->convert("csv","xml",$csvFileLocation,$outputFileLocation);
?&gt;    
</code>
</pre>
</div>