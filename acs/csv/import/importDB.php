...
if(isset($_POST['import']))
{
	...
	//set csv separtor
	if($_POST["csvSeparator"]!="")
		$ACS->delimiter=$_POST["csvSeparator"];
	...
	{
		 $message="<div class='error'>".$ACS->error."</div>";	
	}	
	
}


//get all the tables from database to display in select dropdown
$tables=$ACS->getDBTables(); 

include("../../header.php");
include("../../leftsidebar.php");
?>
<h4>Convert CSV to DB</h4><hr />
<div class="from">
  ...
  <form method="post" enctype="multipart/form-data">
    ...
    <div id="hiddenContent">
      ...
      <div class="formRow">
       ...
       <div class="formRow">
        <div class="formLabel">CSV Separator</div>
        <div class="formField">
          <input type="text" name="csvSeparator" id="csvSeparator" value="," />
        </div>
      </div>
      <div class="formRow">
        <div class="formLabel">Is First Row Contains Column Names ?</div>
        <div class="formField">
...
/* $csvFileLocation = location of the csv file (i.e. complete path of the uploaded csv file)  */	
   $ACS->convert("csv","db",$csvFileLocation);
?&gt;    
</code>
</pre>
</div>