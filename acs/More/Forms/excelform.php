...
if(isset($_POST['import']))
{
	...
	//set append=true as we will add new row in excel everytime on insert operation
	$ACS->append=true;
	
	//set path of the existing excel file, on which we will save/append data
	$ACS->existingFilePath="demo_excel_csv/STUDENTS.xls";
...
?>
<h4>Insert/Append records to excel</h4><hr />
<div class="from">
...
<div class="code">
<h5 class="head5">Code For Excel</h5>
<pre>
...
$ACS->arrayToExcel($data); //convert array to excel
