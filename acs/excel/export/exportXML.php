...
/******* Code For reading the xml format and generate excel format file in specific location******************/
...
if(isset($_POST['import']))
{
	...
	{  
		...
		/* Step 3: call the convert method to reading the xml Format and generate file in excel format*/			
		$ACS->convert("xml","excel",$path,$outputFile);
...
?>
<h4>Excel Generate From XML</h4><hr />
<div class="from">
...
/* $outputFileLocation = location of the output file (i.e. complete path of the output file)  */	
   $ACS->convert("xml","excel",$xmlFileLocation,$outputFileLocation);
?&gt;    
</code>
</pre>
</div>