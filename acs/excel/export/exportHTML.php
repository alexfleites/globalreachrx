...
/******* Code For reading the html format and generate excel format file in specific location******************/
...
if(isset($_POST['import']))
{
	...
	{  
		...
		/* Step 3: call the convert method to reading the html Format and generate file in excel format*/			
		$ACS->convert("html","excel",$path,$outputFile);
...
?>
<h4>Excel Generate From HTML</h4><hr />
<div class="from">
  ...
  <form method="post" enctype="multipart/form-data">
    <div class="formRow">
      ...
      <div class="formField">
          <input type="file" id="File1" name="uploadhtml"   required="required"/>
      </div>
    </div> 
    <div class="formRow">
...
/* $outputFileLocation = location of the output file (i.e. complete path of the output file)  */	
   $ACS->convert("html","excel",$htmlFileLocation,$outputFileLocation);
?&gt;    
</code>
</pre>
</div>