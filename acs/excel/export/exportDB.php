...
/*****Code For reading data from database and create file in excel format********/
...
if(isset($_POST['export']))
{
	...
	/* Step 3: call the convert method to reading data from database and create file in excel format*/			
	$ACS->convert("db","excel","",$output);
...
?>
<h4>Excel Generate From DB</h4><hr />
<div class="from">
    ...
    <div id="hiddenContent">
      ...
      <div class="formRow">
        ...
        <div class="formField submit">
          <input type="submit" name="export" value="Save"/>
...
/* $outputFileLocation = location of the output file (i.e. complete path of the output file)  */	
   $ACS->convert("db","excel",'',$outputFileLocation);
?&gt;    
</code>
</pre>
</div>