...
/******* Code For reading the excel format and writing it into pdf format file in specific location********/
...
if(isset($_POST['import']))
{
	...
	//set the generating file or not
	$ACS->isFile="True";
	...
	{  
		...
		/* Step 3: call the convert method to reading the excel Format and generate file in pdf format*/			
		$ACS->convert("excel","pdf",$path,$outputFile);
...
?>
<h4>Convert Excel to PDF</h4><hr />
<div class="from">
<?php if(isset($message)) echo $message; ?>
<form method="post" enctype="multipart/form-data">
<div class="formRow">
<div class="formLabel">Upload Excel</div><div class="formField"><input type="file" id="File1" name="uploadExcel"  required="required"/></div>
</div>
<div class="formRow">
...
<div class="formRow">
<div class="formLabel">Excel Format</div><div class="formField"><select name="excelType"><option value="Excel5">Excel5</option><option value="2007">Excel2007</option></select></div>
</div>
<div class="formRow">
...
<div class="formRow">
<div class="formLabel">Output File Name</div><div class="formField"><input type="text" name="outputPath" value="file.pdf" /></div>
</div>
<div class="formRow">
...
/* $outputFileLocation = location of the output file (i.e. complete path of the output file)  */	
   $ACS->convert("excel","pdf",$excelFileLocation,$outputFileLocation);
?&gt;    
</code>
</pre>
</div>