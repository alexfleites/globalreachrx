...
/******* Code For reading the excel format and writing it into csv file format********/
...
if(isset($_POST['import']))
{
	...
	{  
		...
		/* Step 3: call the convert method to reading the excel Format and generate file in csv format*/			
		$ACS->convert("excel","csv",$path,$outputPath);
...
?>
<h4>Convert Excel to CSV</h4><hr />
<div class="from">
  <?php if(isset($message)) echo $message; ?>
  <form method="post" enctype="multipart/form-data">
    <div class="formRow">
      <div class="formLabel">Upload Excel</div>
      <div class="formField">
        <input type="file" id="File1" name="uploadXsl"  required="required"/>
      </div>
    </div>
    <div class="formRow">
...
/* $outputFileLocation = location of the output file (i.e. complete path of the output file)  */	
   $ACS->convert("excel","csv",$excelFileLocation,$outputFileLocation);
?&gt;    
</code>
</pre>
</div>