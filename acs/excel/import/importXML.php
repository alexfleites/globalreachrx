...
/******* Code For reading the excel format and writing it into xml format file in specific location********/
...
if(isset($_POST['import']))
{
	...
	if($ACS->fileUpload($_FILES['uploadCsv'],$ACS->fileUploadPath,$ACS->maxSize,array("xls","xlsx")))
	{  
		...
		$ACS->convert("excel","xml",$path,$outputFile);
